 ...
 */
#define DEF_USE_SPI_NOR_FLASH    0
...
static void sys_init(void)
{
    ...
    GPIO_SetSlewCtl(PH, BIT13, GPIO_SLEWCTL_FAST1);
    GPIO_SetSlewCtl(PJ, (BIT3 | BIT4 | BIT5 | BIT6 | BIT7), GPIO_SLEWCTL_FAST1);
