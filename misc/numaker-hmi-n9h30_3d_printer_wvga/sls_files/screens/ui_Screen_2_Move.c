...
void ui_Screen_2_Move_screen_init(void)
{
    ...
    ui_Background1 = lv_image_create(ui_Screen_2_Move);
    lv_image_set_src(ui_Background1, &ui_img_3d_printer_bg_png);
    ...
    lv_image_set_inner_align(ui_Background1, LV_IMAGE_ALIGN_TILE);
    ...
    lv_obj_remove_flag(ui_Panel_Header1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_IMG_Wifi1 = lv_image_create(ui_Panel_Header1);
    lv_image_set_src(ui_IMG_Wifi1, &ui_img_icn_wifi_png);
    ...
    ui_IMG_PC1 = lv_image_create(ui_Panel_Header1);
    lv_image_set_src(ui_IMG_PC1, &ui_img_icn_pc_png);
    ...
    ui_IMG_USB1 = lv_image_create(ui_Panel_Header1);
    lv_image_set_src(ui_IMG_USB1, &ui_img_icn_usb_png);
    ...
    ui_BTN_Menu_Print_S2 = lv_image_create(ui_Screen_2_Move);
    lv_image_set_src(ui_BTN_Menu_Print_S2, &ui_img_btn_print_png);
    ...
    lv_obj_remove_flag(ui_BTN_Menu_Print_S2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_BTN_Menu_Print_S2, LV_IMAGE_ALIGN_TILE);
    lv_obj_set_style_opa(ui_BTN_Menu_Print_S2, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BTN_Menu_Move_S2 = lv_image_create(ui_Screen_2_Move);
    lv_image_set_src(ui_BTN_Menu_Move_S2, &ui_img_btn_move_png);
    ...
    lv_obj_remove_flag(ui_BTN_Menu_Move_S2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_BTN_Menu_Move_S2, LV_IMAGE_ALIGN_TILE);

    ui_BTN_Menu_Setting_S2 = lv_image_create(ui_Screen_2_Move);
    lv_image_set_src(ui_BTN_Menu_Setting_S2, &ui_img_btn_setting_png);
    ...
    lv_obj_remove_flag(ui_BTN_Menu_Setting_S2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_BTN_Menu_Setting_S2, LV_IMAGE_ALIGN_TILE);
    ...
    lv_obj_remove_flag(ui_S1_Content_Panel1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_Display_Pos_XY, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_DP1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_DP2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_Display_Pos_y, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_DP3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_BTN_Move_Z = lv_image_create(ui_S1_Content_Panel1);
    lv_image_set_src(ui_BTN_Move_Z, &ui_img_btn_z_botton_png);
    ...
    lv_image_set_inner_align(ui_BTN_Move_Z, LV_IMAGE_ALIGN_TILE);
    ...
    ui_BTN_Image_Top = lv_image_create(ui_BTN_Move_Z);
    lv_image_set_src(ui_BTN_Image_Top, &ui_img_btn_z_top_png);
    ...
    ui_Arrow_Z_up = lv_image_create(ui_BTN_Image_Top);
    lv_image_set_src(ui_Arrow_Z_up, &ui_img_arrow_up_png);
    ...
    lv_obj_remove_flag(ui_Arrow_Z_up, LV_OBJ_FLAG_PRESS_LOCK | LV_OBJ_FLAG_CLICK_FOCUSABLE | LV_OBJ_FLAG_GESTURE_BUBBLE |
                       LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM |
                       LV_OBJ_FLAG_SCROLL_CHAIN);     /// Flags
    lv_obj_set_style_image_recolor(ui_Arrow_Z_up, lv_color_hex(0xABC1ED), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Z_up, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor(ui_Arrow_Z_up, lv_color_hex(0x00D1FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Z_up, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor(ui_Arrow_Z_up, lv_color_hex(0x00D1FF), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Z_up, 255, LV_PART_MAIN | LV_STATE_PRESSED);

    ui_Arrow_Z_Down = lv_image_create(ui_BTN_Image_Top);
    lv_image_set_src(ui_Arrow_Z_Down, &ui_img_arrow_down_png);
    ...
    lv_obj_set_style_image_recolor(ui_Arrow_Z_Down, lv_color_hex(0xABC1ED), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Z_Down, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor(ui_Arrow_Z_Down, lv_color_hex(0x00D2FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Z_Down, 255, LV_PART_MAIN | LV_STATE_CHECKED);

    ui_BTN_Move_XY = lv_image_create(ui_S1_Content_Panel1);
    lv_image_set_src(ui_BTN_Move_XY, &ui_img_btn_pad_bottom_png);
    ...
    ui_BTN_Move_XY_Top = lv_image_create(ui_BTN_Move_XY);
    lv_image_set_src(ui_BTN_Move_XY_Top, &ui_img_btn_pad_top_png);
    ...
    lv_image_set_pivot(ui_BTN_Move_XY_Top, 121, 118);
    ...
    ui_Arrow_Up_2 = lv_image_create(ui_BTN_Move_XY_Top);
    lv_image_set_src(ui_Arrow_Up_2, &ui_img_arrow_up_png);
    ...
    lv_obj_set_style_image_recolor(ui_Arrow_Up_2, lv_color_hex(0xABC1ED), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Up_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor(ui_Arrow_Up_2, lv_color_hex(0x00D2FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Up_2, 255, LV_PART_MAIN | LV_STATE_CHECKED);

    ui_Arrow_Down_2 = lv_image_create(ui_BTN_Move_XY_Top);
    lv_image_set_src(ui_Arrow_Down_2, &ui_img_arrow_down_png);
    ...
    lv_obj_set_style_image_recolor(ui_Arrow_Down_2, lv_color_hex(0xABC1ED), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Down_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor(ui_Arrow_Down_2, lv_color_hex(0x00D2FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Down_2, 255, LV_PART_MAIN | LV_STATE_CHECKED);

    ui_Arrow_Left_2 = lv_image_create(ui_BTN_Move_XY_Top);
    lv_image_set_src(ui_Arrow_Left_2, &ui_img_arrow_left_png);
    ...
    lv_obj_set_style_image_recolor(ui_Arrow_Left_2, lv_color_hex(0xABC1ED), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Left_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor(ui_Arrow_Left_2, lv_color_hex(0x00D2FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Left_2, 255, LV_PART_MAIN | LV_STATE_CHECKED);

    ui_Arrow_Right_2 = lv_image_create(ui_BTN_Move_XY_Top);
    lv_image_set_src(ui_Arrow_Right_2, &ui_img_arrow_right_png);
    ...
    lv_obj_set_style_image_recolor(ui_Arrow_Right_2, lv_color_hex(0xABC1ED), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Right_2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor(ui_Arrow_Right_2, lv_color_hex(0x00D2FF), LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_image_recolor_opa(ui_Arrow_Right_2, 255, LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    lv_obj_remove_flag(ui_Roller_Number, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Image8 = lv_image_create(ui_Roller_Number);
    lv_image_set_src(ui_Image8, &ui_img_roller_bg_png);
    ...
    ui_BTN_Reset = lv_imagebutton_create(ui_S1_Content_Panel1);
    lv_imagebutton_set_src(ui_BTN_Reset, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_btn_main_off_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Reset, LV_IMAGEBUTTON_STATE_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Reset, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Reset, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, NULL, &ui_img_btn_main_on_png, NULL);
    ...
    ui_BTN_Heat = lv_imagebutton_create(ui_S1_Content_Panel1);
    lv_imagebutton_set_src(ui_BTN_Heat, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_btn_main_off_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat, LV_IMAGEBUTTON_STATE_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, NULL, &ui_img_btn_main_on_png, NULL);
