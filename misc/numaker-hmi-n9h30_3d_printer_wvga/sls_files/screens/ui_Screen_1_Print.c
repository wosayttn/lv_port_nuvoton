...
void ui_Screen_1_Print_screen_init(void)
{
    ...
    ui_IMG_Wifi = lv_image_create(ui_Panel_Header);
    lv_image_set_src(ui_IMG_Wifi, &ui_img_icn_wifi_png);
    ...
    ui_IMG_PC = lv_image_create(ui_Panel_Header);
    lv_image_set_src(ui_IMG_PC, &ui_img_icn_pc_png);
    ...
    ui_IMG_USB = lv_image_create(ui_Panel_Header);
    lv_image_set_src(ui_IMG_USB, &ui_img_icn_usb_png);
    ...
    ui_BTN_Menu_Print_S1 = lv_image_create(ui_Screen_1_Print);
    lv_image_set_src(ui_BTN_Menu_Print_S1, &ui_img_btn_print_png);
    ...
    ui_BTN_Menu_Move_S1 = lv_image_create(ui_Screen_1_Print);
    lv_image_set_src(ui_BTN_Menu_Move_S1, &ui_img_btn_move_png);
    ...
    lv_obj_remove_flag(ui_BTN_Menu_Move_S1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_BTN_Menu_Move_S1, LV_IMAGE_ALIGN_TILE);
    lv_obj_set_style_opa(ui_BTN_Menu_Move_S1, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BTN_Menu_Setting_S1 = lv_image_create(ui_Screen_1_Print);
    ...
    lv_obj_set_style_bg_image_src(ui_Slider_Print_View, &ui_img_print_view_bg_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_image_src(ui_Slider_Print_View, &ui_img_print_view_front_png, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_Display_Time_S1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_remove_flag(ui_DT1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_IMG_Tine_1 = lv_image_create(ui_DT1);
    lv_image_set_src(ui_IMG_Tine_1, &ui_img_icn_time_1_png);
    ...
    ui_IMG_Tine_2 = lv_image_create(ui_DT2);
    lv_image_set_src(ui_IMG_Tine_2, &ui_img_icn_time_2_png);
    ...
    lv_obj_remove_flag(ui_Display_Heat_S1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_IMG_Head = lv_image_create(ui_DT3);
    lv_image_set_src(ui_IMG_Head, &ui_img_icn_head_png);
    ...
    lv_obj_remove_flag(ui_DT3_copy, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_IMG_Head1 = lv_image_create(ui_DT3_copy);
    lv_image_set_src(ui_IMG_Head1, &ui_img_icn_bed_png);
    ...
    ui_BTN_Pause = lv_image_create(ui_Panel_Buttons_S1);
    lv_image_set_src(ui_BTN_Pause, &ui_img_btn_print_down_png);
    ...
    ui_BTN_Pause_Top = lv_image_create(ui_BTN_Pause);
    ...
    lv_image_set_src(ui_Image_Pause, &ui_img_icn_pause_png);
