...
void ui_Screen_3_Setting_screen_init(void)
{
    ...
    ui_Background2 = lv_image_create(ui_Screen_3_Setting);
    lv_image_set_src(ui_Background2, &ui_img_3d_printer_bg_png);
    ...
    ui_IMG_Wifi2 = lv_image_create(ui_Panel_Header2);
    lv_image_set_src(ui_IMG_Wifi2, &ui_img_icn_wifi_png);
    ...
    ui_IMG_PC2 = lv_image_create(ui_Panel_Header2);
    lv_image_set_src(ui_IMG_PC2, &ui_img_icn_pc_png);
    ...
    ui_IMG_USB2 = lv_image_create(ui_Panel_Header2);
    lv_image_set_src(ui_IMG_USB2, &ui_img_icn_usb_png);
    ...
    lv_obj_set_style_bg_image_src(ui_BTN_Menu_Print_S3, &ui_img_btn_print_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_BTN_Menu_Move_S3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_BTN_Menu_Move_S3, &ui_img_btn_move_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_image_src(ui_BTN_Menu_Setting_S3, &ui_img_btn_setting_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_Roller_Material, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Image3 = lv_image_create(ui_Roller_Material);
    lv_image_set_src(ui_Image3, &ui_img_roller_bg_png);
    ...
    lv_obj_remove_flag(ui_Roller_Bed_Temp, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Image2 = lv_image_create(ui_Roller_Bed_Temp);
    lv_image_set_src(ui_Image2, &ui_img_roller_bg_png);
    ...
    lv_obj_remove_flag(ui_Roller_Head_Temp, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_Image1 = lv_image_create(ui_Roller_Head_Temp);
    lv_image_set_src(ui_Image1, &ui_img_roller_bg_png);
    ...
    ui_BTN_Heat_Head = lv_imagebutton_create(ui_S1_Content_Panel2);
    lv_imagebutton_set_src(ui_BTN_Heat_Head, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_btn_main_off_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat_Head, LV_IMAGEBUTTON_STATE_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat_Head, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat_Head, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, NULL, &ui_img_btn_main_on_png, NULL);
    ...
    ui_BTN_Heat_Bed = lv_imagebutton_create(ui_S1_Content_Panel2);
    lv_imagebutton_set_src(ui_BTN_Heat_Bed, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_btn_main_off_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat_Bed, LV_IMAGEBUTTON_STATE_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat_Bed, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Heat_Bed, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, NULL, &ui_img_btn_main_on_png, NULL);
    ...
    ui_BTN_Remove_Filament = lv_imagebutton_create(ui_S1_Content_Panel2);
    lv_imagebutton_set_src(ui_BTN_Remove_Filament, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_btn_main_off_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Remove_Filament, LV_IMAGEBUTTON_STATE_PRESSED, NULL, &ui_img_btn_main_on_png, NULL);
    lv_imagebutton_set_src(ui_BTN_Remove_Filament, LV_IMAGEBUTTON_STATE_CHECKED_PRESSED, NULL, &ui_img_btn_main_on_png,
                           NULL);
    lv_imagebutton_set_src(ui_BTN_Remove_Filament, LV_IMAGEBUTTON_STATE_CHECKED_RELEASED, NULL, &ui_img_btn_main_on_png,
                           NULL);
    ...
    lv_obj_set_style_shadow_offset_x(ui_Slider_Print_Speed, -2, LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_offset_y(ui_Slider_Print_Speed, 0, LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    if (lv_obj_get_style_pad_top(ui_Slider_Print_Speed, LV_PART_MAIN) > 0) lv_obj_set_style_pad_right(ui_Slider_Print_Speed,
                lv_obj_get_style_pad_right(ui_Slider_Print_Speed, LV_PART_MAIN) + 1, LV_PART_MAIN);
    ...
    lv_obj_set_style_shadow_offset_x(ui_Switch_Light, -3, LV_PART_KNOB | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_offset_y(ui_Switch_Light, 0, LV_PART_KNOB | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_shadow_offset_x(ui_Switch_Fan_1, -3, LV_PART_KNOB | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_offset_y(ui_Switch_Fan_1, 0, LV_PART_KNOB | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_shadow_offset_x(ui_Switch_Fan_2, -3, LV_PART_KNOB | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_offset_y(ui_Switch_Fan_2, 0, LV_PART_KNOB | LV_STATE_CHECKED);
    ...
    lv_obj_set_style_shadow_offset_x(ui_Switch_Fan_3, -3, LV_PART_KNOB | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_offset_y(ui_Switch_Fan_3, 0, LV_PART_KNOB | LV_STATE_CHECKED);
