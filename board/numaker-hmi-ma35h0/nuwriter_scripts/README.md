...
### [USB Driver for Window](https://github.com/OpenNuvoton/MA35H0_NuWriter/blob/master/driver/WinUSB4NuVCOM.exe?raw=true)
...
Download GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into DDR. The address is 0x80000000.

### **nuwriter_program_sd.bat**

Program header0, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into SD card or EMMC.

### **nuwriter_program_spinand.bat**

Program header0, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into SPI NAND flash.

### **nuwriter_program_rawnand.bat**

Program header0, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into NAND flash.

### **nuwriter_program_sd_pack1.bat**

Program header1, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into SD card or EMMC.

### **nuwriter_program_spinand_pack1.bat**

Program header1, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into SPI NAND flash.

### **nuwriter_program_rawnand_pack1.bat**

Program header1, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into NAND flash.

### **nuwriter_program_spinor_pack1.bat**

Program header1, DDR timing setting and GCC\MA35H0_1024x600\lvgl_ma35h0.bin binary file into SPI NOR flash.

## **Program firmware using NuWriter**

To switch SW4 dip-switch on NuMaker-BASE-MA35H0B1 to do corresponding actions as below.
...
IF %ERRORLEVEL% EQU 0 (
   NuWriter_MA35.exe -o execute -w ddr 0x80000000 ../../GCC/MA35H0_1024x600/lvgl_ma35h0.bin
)
pause
