...
#define CONFIG_DISP_PIN_DC           NU_GET_PININDEX(evGF, 9)   //89    //PF9
#define CONFIG_DISP_PIN_RESET        NU_GET_PININDEX(evGF, 10)  //90    //PF10
#define CONFIG_DISP_PIN_BACKLIGHT    NU_GET_PININDEX(evGG, 7)   //103   //PG7
