...
#define CONFIG_DISP_PIN_DC           NU_GET_PININDEX(evGA, 8)
#define CONFIG_DISP_PIN_RESET        NU_GET_PININDEX(evGA, 9)
#define CONFIG_DISP_PIN_BACKLIGHT    NU_GET_PININDEX(evGA, 11)
