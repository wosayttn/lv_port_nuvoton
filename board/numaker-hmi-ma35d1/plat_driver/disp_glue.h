...
#if defined(CONFIG_LV_DISP_DIRECT_REFRESH)
    #define CONFIG_DISP_DIRECT_REFRESH  CONFIG_LV_DISP_DIRECT_REFRESH
#endif

#if !defined(CONFIG_DISP_DIRECT_REFRESH)
    #define CONFIG_DISP_DIRECT_REFRESH  0
#endif
...
#define CONFIG_DISPLAY_BOARD_NAME   "MA35D1  display board"
