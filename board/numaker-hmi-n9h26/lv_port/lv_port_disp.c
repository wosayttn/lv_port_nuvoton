...
#include "lvgl.h"
#include "lv_glue.h"
#if (CONFIG_LV_GPU_USE_N9H26_BLT==1)
...
#if (CONFIG_LV_GPU_USE_N9H26_BLT==1)
    disp_drv.draw_ctx_init = lv_draw_n9h26_blt_ctx_init;
    disp_drv.draw_ctx_deinit = lv_draw_n9h26_blt_ctx_init;
    disp_drv.draw_ctx_size = sizeof(lv_draw_n9h26_blt_ctx_t);
#endif
