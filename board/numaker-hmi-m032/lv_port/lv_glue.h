...
#define CONFIG_DISP_PIN_DC           NU_GET_PININDEX(evGB, 2)  //18
#define CONFIG_DISP_PIN_RESET        NU_GET_PININDEX(evGB, 3)  //19
#define CONFIG_DISP_PIN_BACKLIGHT    NU_GET_PININDEX(evGA, 6)  //6
