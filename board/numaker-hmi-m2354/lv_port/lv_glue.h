...
#define CONFIG_DISP_LINE_BUFFER_NUMBER  (LV_VER_RES_MAX/8)
...
#define CONFIG_DISP_PIN_DC           NU_GET_PININDEX(evGA, 8)   //8
#define CONFIG_DISP_PIN_RESET        NU_GET_PININDEX(evGA, 9)   //9
#define CONFIG_DISP_PIN_BACKLIGHT    NU_GET_PININDEX(evGC, 11)  //43
