...
#pragma anon_unions
#endif
/** @addtogroup CRYPTO REGISTER Control Register
 ...
 * |        |          |The RSA accelerator supports DMA function to transfer the DATA and PARAMETER between SRAM memory space and RSA accelerator.
 * |        |          |This register is stored the address of RSA SCAP the Temporary Value (Eu2019).
 ...
 * |        |          |Get data as OUTBUFEMPTY is 0.
 * @var CRYPTO_T::CHAPOLY_KEY0
 * Offset: 0xC10  ChaCha20/Poly1305 Key Word 0 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CRYPTO_T::CHAPOLY_KEY1
 * Offset: 0xC14  ChaCha20/Poly1305 Key Word 1 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * |        |          |The security key for ChaCha20/Poly1305 accelerator must be 256 bits and eight 32-bit registers are to store each security key.
 * |        |          |{CRYPTO_CHAPOLY_KEY7, CRYPTO_CHAPOLY_KEY6, CRYPTO_CHAPOLY_KEY5, CRYPTO_CHAPOLY_KEY4, CRYPTO_CHAPOLY_KEY3, CRYPTO_CHAPOLY_KEY2, CRYPTO_CHAPOLY_KEY1, CRYPTO_CHAPOLY_KEY0} stores the 256-bit security key for ChaCha20/Poly1305 operation.
 * @var CRYPTO_T::CHAPOLY_KEY2
 * Offset: 0xC18  ChaCha20/Poly1305 Key Word 2 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * |        |          |The security key for ChaCha20/Poly1305 accelerator must be 256 bits and eight 32-bit registers are to store each security key.
 * |        |          |{CRYPTO_CHAPOLY_KEY7, CRYPTO_CHAPOLY_KEY6, CRYPTO_CHAPOLY_KEY5, CRYPTO_CHAPOLY_KEY4, CRYPTO_CHAPOLY_KEY3, CRYPTO_CHAPOLY_KEY2, CRYPTO_CHAPOLY_KEY1, CRYPTO_CHAPOLY_KEY0} stores the 256-bit security key for ChaCha20/Poly1305 operation.
 * @var CRYPTO_T::CHAPOLY_KEY3
 * Offset: 0xC1C  ChaCha20/Poly1305 Key Word 3 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * |        |          |The security key for ChaCha20/Poly1305 accelerator must be 256 bits and eight 32-bit registers are to store each security key.
 * |        |          |{CRYPTO_CHAPOLY_KEY7, CRYPTO_CHAPOLY_KEY6, CRYPTO_CHAPOLY_KEY5, CRYPTO_CHAPOLY_KEY4, CRYPTO_CHAPOLY_KEY3, CRYPTO_CHAPOLY_KEY2, CRYPTO_CHAPOLY_KEY1, CRYPTO_CHAPOLY_KEY0} stores the 256-bit security key for ChaCha20/Poly1305 operation.
 * @var CRYPTO_T::CHAPOLY_KEY4
 * Offset: 0xC20  ChaCha20/Poly1305 Key Word 4 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * |        |          |The security key for ChaCha20/Poly1305 accelerator must be 256 bits and eight 32-bit registers are to store each security key.
 * |        |          |{CRYPTO_CHAPOLY_KEY7, CRYPTO_CHAPOLY_KEY6, CRYPTO_CHAPOLY_KEY5, CRYPTO_CHAPOLY_KEY4, CRYPTO_CHAPOLY_KEY3, CRYPTO_CHAPOLY_KEY2, CRYPTO_CHAPOLY_KEY1, CRYPTO_CHAPOLY_KEY0} stores the 256-bit security key for ChaCha20/Poly1305 operation.
 * @var CRYPTO_T::CHAPOLY_KEY5
 * Offset: 0xC24  ChaCha20/Poly1305 Key Word 5 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * |        |          |The security key for ChaCha20/Poly1305 accelerator must be 256 bits and eight 32-bit registers are to store each security key.
 * |        |          |{CRYPTO_CHAPOLY_KEY7, CRYPTO_CHAPOLY_KEY6, CRYPTO_CHAPOLY_KEY5, CRYPTO_CHAPOLY_KEY4, CRYPTO_CHAPOLY_KEY3, CRYPTO_CHAPOLY_KEY2, CRYPTO_CHAPOLY_KEY1, CRYPTO_CHAPOLY_KEY0} stores the 256-bit security key for ChaCha20/Poly1305 operation.
 * @var CRYPTO_T::CHAPOLY_KEY6
 * Offset: 0xC28  ChaCha20/Poly1305 Key Word 6 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * |        |          |The security key for ChaCha20/Poly1305 accelerator must be 256 bits and eight 32-bit registers are to store each security key.
 * |        |          |{CRYPTO_CHAPOLY_KEY7, CRYPTO_CHAPOLY_KEY6, CRYPTO_CHAPOLY_KEY5, CRYPTO_CHAPOLY_KEY4, CRYPTO_CHAPOLY_KEY3, CRYPTO_CHAPOLY_KEY2, CRYPTO_CHAPOLY_KEY1, CRYPTO_CHAPOLY_KEY0} stores the 256-bit security key for ChaCha20/Poly1305 operation.
 * @var CRYPTO_T::CHAPOLY_KEY7
 * Offset: 0xC2C  ChaCha20/Poly1305 Key Word 7 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |KEY       |CRYPTO_CHAPOLY_KEYx
 ...
 * @var CRYPTO_T::CHAPOLY_NONCE0
 * Offset: 0xC34  ChaCha20/Poly1305 Nonce Word 0 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 ...
 * @var CRYPTO_T::CHAPOLY_NONCE1
 * Offset: 0xC38  ChaCha20/Poly1305 Nonce Word 1 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |Nonce     |ChaCha20/Poly1305 Nonce
 * |        |          |x = 0, 1, 2.
 * |        |          |96-bit Nonce for ChaCha20 and AEAD modes
 * @var CRYPTO_T::CHAPOLY_NONCE2
 * Offset: 0xC3C  ChaCha20/Poly1305 Nonce Word 2 Register
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |Nonce     |ChaCha20/Poly1305 Nonce
 ...
 * @var CRYPTO_T::CHAPOLY_ACNT0
 * Offset: 0xC50  ChaCha20/Poly1305 A Byte Count Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |CNT       |ChaCha20/Poly1305   A Byte Count
 * |        |          |The bit   length of A is 64 bits for AEAD mode
 * |        |          |The CRYPTO_CHAPOLY_ACNT0 keeps the low   weight byte count of the additional authenticated data (i.e., len(A)[34:3]) of   AEAD mode and can be read and written.
 * @var CRYPTO_T::CHAPOLY_ACNT1
 * Offset: 0xC54  ChaCha20/Poly1305 A Byte Count Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[28:0]  |CNT       |ChaCha20/Poly1305   A Byte Count
 * |        |          |The bit   length of A is 64 bits for AEAD mode
 * |        |          |The CRYPTO_CHAPOLY_ACNT0 keeps the high   weight byte count of the additional authenticated data (i.e., len(A)[63:35]) of   AEAD mode and can be read and written.
 * @var CRYPTO_T::CHAPOLY_PCNT0
 * Offset: 0xC58  ChaCha20/Poly1305 P Byte Count Register 0
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[31:0]  |CNT       |ChaCha20/Poly1305   P Byte Count
 * |        |          |The bit   length of P or C is 64 bits for AEAD mode
 * |        |          |The CRYPTO_CHAPOLY_PCNT0 keeps the   low weight byte count of the plaintext or ciphertext (i.e., len(P)[34:3] or   len(C)[34:3]) of AEAD mode and can be read and written.
 * @var CRYPTO_T::CHAPOLY_PCNT1
 * Offset: 0xC5C  ChaCha20/Poly1305 P Byte Count Register 1
 * ---------------------------------------------------------------------------------------------------
 * |Bits    |Field     |Descriptions
 * | :----: | :----:   | :---- |
 * |[28:0]  |CNT       |ChaCha20/Poly1305   P Byte Count
 * |        |          |The bit   length of P or C is 64 bits for AEAD mode
 * |        |          |The CRYPTO_CHAPOLY_PCNT1 keeps the   high weight byte count of the plaintext or ciphertext (i.e.,   len(P)[64:35] or len(C)[64:35]) of AEAD
 ...
 */
    ...
    __IO uint32_t RSA_KSSTS[2];            /*!< [0x0f54] RSA Key Status Register 0                                        */
