...
{
    LV_LOG_ERROR("Implement your init routine in lv_glue.c");
...
{
    LV_LOG_ERROR("Implement your i2c_read routine in lv_glue.c");
...
{
    LV_LOG_ERROR("Implement your ad i2c_write routine in lv_glue.c");
...
{
    LV_LOG_ERROR("Implement your fini routine in lv_glue.c");
}
